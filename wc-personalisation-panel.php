...
function wcpp_init() {
	...
	// Load plugin translations. Must run before any translatable string fires.
	load_plugin_textdomain( 'wcpp', false, dirname( WCPP_BASENAME ) . '/languages' );
